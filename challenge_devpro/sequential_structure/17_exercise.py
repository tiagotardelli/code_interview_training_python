...
Consider that the paint coverage is 1 liter for every 6 square meters and that the paint is sold in 18 cans.
liters, which cost R$ 80.00 or in 3.6 liter gallons, which cost R$ 25.00.
Inform the user of the quantities of paint to be purchased and the respective prices in 3 situations:
    ...
    c) mix cans and gallons, so that the waste of paint is less. Add 10% off and always
    round values up, that is, consider full cans.
######################################################################################################################
